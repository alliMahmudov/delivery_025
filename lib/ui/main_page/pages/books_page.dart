          ...
          itemBuilder: (context, index) {
            ...
            return ClipRRect(
              ...
              child: GestureDetector(
                              ...
                              children: [
                                ...
                                Consumer<SPList>(
                                  builder: (context, value, child) {
                                    final totalPrice = booksItem.price * value.qty;
                                              ...
                                              ClipRRect(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: IconButton(
                                                    onPressed: () {
                                                      ///
                                                      value.removeItem(booksItem.id,booksItem);
                                                      value.decrementQTY();
                                                      value.saveIntoSp();
                                                      ///
                                                    },
                ...
                child: ProductItemWidget(productItem: booksItem, isBook: true,)
              ),
            );
          },
        ),
